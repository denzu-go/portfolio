...
$sql = "SELECT * FROM constants_about";
...
while ($fetched = $result->fetch_assoc()) {
    ...
    $show_actions = '
        <i id="edit_constant" class="fas fa-pen btn text-secondary p-2 m-0" data-id="' . $id . '" data-title="' . $title . '" data-instruction="' . $instruction . '" data-text="' . $text . '">
        </i>
    ';
