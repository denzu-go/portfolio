...
if (isset($_POST['linkInput']) && isset($_POST['newOutputVisibility']) && isset($_POST['clientSelect']) ) {
    // Collect form data
    ...
    $sqlInsertOutput = "INSERT INTO video_outputs (link, is_visible, date_added) VALUES ('$linkInput', $newOutputVisibility, NOW())";
