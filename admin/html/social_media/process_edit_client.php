...
if (isset($_POST['clientId']) && isset($_POST['clientName']) && isset($_POST['clientVisibility']) && isset($_POST['date_added_client'])) {
    ...
    $sqlUpdateClient = "UPDATE social_media_clients SET client_name = '$clientName', is_visible = $clientVisibility, date_added = '$date_added_client' WHERE client_id = $clientId";
