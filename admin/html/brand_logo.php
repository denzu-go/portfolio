  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <h5 class="card-title fw-semibold">Brand & Logo</h5>
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#saveNewClient").click(function() {
        ...
        $.ajax({
          url: 'brand_logo/process_add_client.php',
          type: 'POST',
          data: {
      ...
      $('#clientsTable').DataTable({
        ...
        scrollX: true,
        ajax: {
          url: "brand_logo/json_clients_table.php",
          data: {},
          dataSrc: ""
        },
        columnDefs: [{
      ...
      $('#clientsTable').on('click', '#delete_client', function() {
        ...
        swal({
          ...
          if (confirmed) {
            $.ajax({
              url: 'brand_logo/process_delete_client.php',
              type: 'POST',
              data: {
                client_id: client_id
              },
      ...
      $(document).on('click', '#saveEditClient', function(event) {
        ...
        $.ajax({
          type: 'POST',
          url: 'brand_logo/process_edit_client.php',
          data: formData,
          success: function(response) {
            $('#clientsTable').DataTable().ajax.reload();
            $('#outputsTable').DataTable().ajax.reload();
      ...
      $('#outputsTable').DataTable({
        ...
        scrollX: true,
        ajax: {
          url: "brand_logo/json_outputs_table.php",
          data: {},
          dataSrc: ""
        },
        columnDefs: [{
      ...
      $('#dropdown_client_table').DataTable({
        ...
        scrollX: false,
        ajax: {
          url: "brand_logo/dropdown_client_table.php",
          data: {},
          dataSrc: ""
        },
        columns: [{
      ...
      $("#addOutput").click(function() {
        ...
        // Send form data to process_add_client.php using AJAX
        $.ajax({
          url: 'brand_logo/process_add_output.php',
          type: 'POST',
          data: {
            linkInput: linkInput,
      ...
      $('#outputsTable').on('click', '#edit_output', function() {
        ...
        $('#dropdown_output_table').DataTable({
          ...
          scrollX: false,
          ajax: {
            url: "brand_logo/dropdown_output_table.php",
            data: {
      ...
      $(document).on('click', '#saveEditOutput', function(event) {
        ...
        $.ajax({
          type: 'POST',
          url: 'brand_logo/process_edit_output.php',
          data: formData,
          success: function(response) {
            $('#clientsTable').DataTable().ajax.reload();
            $('#outputsTable').DataTable().ajax.reload();
      ...
      $('#outputsTable').on('click', '#delete_output', function() {
        ...
        swal({
          ...
          if (confirmed) {
            $.ajax({
              url: 'brand_logo/process_delete_output.php',
              type: 'POST',
              data: {
                output_id: output_id
              },
