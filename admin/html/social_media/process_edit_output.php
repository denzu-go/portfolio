...
if (isset($_POST['outputId']) && isset($_POST['link']) && isset($_POST['outputVisibility']) && isset($_POST['date_added_output']) && isset($_POST['clientSelect'])) {
    ...
    $sqlUpdateOutput = "UPDATE social_media_outputs SET link = '$link', is_visible = $outputVisibility, client_id = $clientSelect, date_added = '$date_added_output' WHERE id = $outputId";
